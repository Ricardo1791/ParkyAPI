...
namespace ParkyAPI.Repository
{
    public class TrailRepository : ITrailRepository
    {
        ...
        {
            return _db.Trails.Include(x => x.NationalPark).ToList();
        }

        public Trail GetTrail(int id)
        {
            return _db.Trails.Include(x => x.NationalPark).Where(x => x.Id == id).FirstOrDefault();
        }
        ...
        {
            return _db.Trails.Any(x => x.Name.ToUpper().Contains(name.ToUpper()));
        }
